...
if len(sys.argv) < 2:
    print '\nUSAGE: python dcpfixity.py directory\n'
    print 'Requires lxml and openssl\n'    
    sys.exit()
else:

    dcp_dir = sys.argv[1]
    if not os.path.isdir(dcp_dir):
        if os.path.isfile(dcp_dir):
        
            print '\nYour input appears to be a file, not a directory\n'
        print '\nUSAGE: python dcpfixity.py directory\n'
        print 'Requires lxml and openssl\n' 
    ...
    # CSV will be saved to the Desktop.
